...
<body class="bg-gray-50 flex items-center justify-center min-h-screen relative overflow-hidden">
    ...
    <div
        class="bg-white p-10 rounded-2xl shadow-2xl max-w-lg w-full text-center border border-gray-100 relative z-10 mx-4">
        ...
        <p class="text-gray-600 mb-8 leading-relaxed">
            Thank you for registering! Your account has been created successfully but is currently waiting for
            Superadmin approval.
        ...
        <form method="POST" action="{{ route('filament.admin.auth.logout') }}">
            @csrf
            <button type="submit"
                class="w-full bg-[#0b9e4f] hover:bg-[#098a44] text-white font-bold py-3 px-4 rounded-xl transition duration-200 shadow-lg shadow-green-200">
                Back to Login
            </button>
        </form>
    </div>
