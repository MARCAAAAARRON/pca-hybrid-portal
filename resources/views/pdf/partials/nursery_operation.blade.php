                    ...
                    @else
                        ...
                        @foreach($varieties as $v)
                            <tr>
                                ...
                                <td style="border: 1px solid #000; padding: 1px 3px; text-align: center;">{{ $v->seednuts_sown }}</td>
                                ...
                                <td style="border: 1px solid #000; padding: 1px 3px; text-align: center;">{{ $v->seedlings_germinated }}</td>
                                ...
                                <td style="border: 1px solid #000; padding: 1px 3px; text-align: center;">{{ $v->seedlings_dispatched }}</td>
                            </tr>
                            @php
